...
"Français":{
  ...
  "typewriter-text":"Développeur Logiciel (Java, Python, PHP)|Étudiant en informatique|Développeur Backend",
  ...
  "project5-title":"Vier Gewinnt (Projet en équipe)",
  "project5-desc":"Développement d'un jeu Puissance 4 en équipe. Responsable de l'<strong>IA</strong> du jeu, affrontant le joueur humain.",
  "project5-task1":"Algorithme <strong>Minimax</strong> avec élagage alpha-bêta",
  "project5-task2":"Évaluation heuristique des <strong>coups</strong> pour les états non terminaux",
  "project5-task3":"3 <strong>niveaux de difficulté</strong> sélectionnables",
  "project5-task4":"Conception orientée objet en <strong>Java</strong>",
  "project5-task5":"Travail d'équipe et gestion de version avec <strong>Git</strong>",
...
"English":{
  ...
  "typewriter-text":"Software Developer (Java, Python, PHP)|Computer Science Student|Backend Developer",
  "skills-title":"Skills",
  ...
  "project5-title":"Connect Four (Team Project)",
  "project5-desc":"Development of a Connect Four game in a team. Responsible for the game's <strong>AI</strong>, playing against the human player.",
  "project5-task1":"<strong>Minimax algorithm</strong> with alpha-beta pruning",
  "project5-task2":"Heuristic <strong>move evaluation</strong> for non-terminal states",
  "project5-task3":"3 selectable <strong>difficulty levels</strong>",
  "project5-task4":"Object-oriented design in <strong>Java</strong>",
  "project5-task5":"Teamwork and version control with <strong>Git</strong>",
  "project4-badge":"Assignment · Fullstack",
...
"Deutsch":{
  ...
  "typewriter-text":"Softwareentwickler (Java, Python, PHP)|Informatikstudent|Backend Entwickler",
  ...
  "project5-title":"Vier Gewinnt (Teamprojekt)",
  "project5-desc":"Entwicklung eines Vier-Gewinnt-Spiels im Team. Verantwortlich für die <strong>KI</strong> des Spiels, die gegen den menschlichen Spieler antritt.",
  "project5-task1":"<strong>Minimax-Algorithmus</strong> mit Alpha-Beta-Pruning",
  "project5-task2":"Heuristische <strong>Zugbewertung</strong> für nicht-terminale Zustände",
  "project5-task3":"3 wählbare <strong>Schwierigkeitsstufen</strong>",
  "project5-task4":"Objektorientiertes Design mit <strong>Java</strong>",
  "project5-task5":"Teamarbeit und Versionsverwaltung mit <strong>Git</strong>",
  "project4-badge":"Assignment · Fullstack",
